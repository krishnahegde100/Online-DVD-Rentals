...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
    	<div id="site_title"><h1><a href="#">Online Dvd Rental</a></h1></div>
        <div id="header_right">
        	<p>
	        <a href="#">My Account</a> | <a href="#">My Playlist</a> | <a href="#">My Cart</a> | <a href="#">Checkout</a> | <a href="#">Log In</a></p>
            <p>
    ...
    <div id="templatemo_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
            <ul>
                ...
                <li><a href="products.php">Movies</a>
                    <ul>
    ...
    <div id="templatemo_main">
    	<div id="sidebar" class="float_l">
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<ul class="sidebar_list">
                        ...
                        <li><a href="#">Family Entertainer</a></li>
            ...
            <div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<div class="bs_box">
                    	<a href="#"><img src="images/001.jpg" alt="image" /></a>
                        <h4><a href="#">Bahubali</a></h4>
                        <p class="price">$100</p>
                        <div class="cleaner"></div>
                    </div>
                    <div class="bs_box">
                    	<a href="#"><img src="images/002.jpg" alt="image" /></a>
                        <h4><a href="#">Rajakumara</a></h4>
                        <p class="price">$100</p>
                        <div class="cleaner"></div>
                    </div>
                    <div class="bs_box">
                    	<a href="#"><img src="images/003.jpg" alt="image" /></a>
                        <h4><a href="#">Dangal</a></h4>
                        <p class="price">$200</p>
                        <div class="cleaner"></div>
                    </div>
                    <div class="bs_box">
                    	<a href="#"><img src="images/004.jpg" alt="image" /></a>
                        <h4><a href="#">The Iron Man</a></h4>
                        <p class="price">$200</p>
                        <div class="cleaner"></div>
                    </div>
                </div>
        ...
        <div id="content" class="float_r faqs">
        	<h1>FAQs</h1>
            <h5>How do I  know if my  Movies order has been placed?</h5>
    ...
    <div id="templatemo_footer">
		...
		Copyright © 2072 <a href="#">Online Dvd Rental</a> <!-- Credit: www.templatemo.com -->
